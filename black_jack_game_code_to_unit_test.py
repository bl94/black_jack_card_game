...
def main(set_of_cards):
    ...
    while game_on:
        ...
        my_deck.all_of_cards.extend(set_of_cards)
        ...
        print("")
        result=GameLogic.who_win(player,dealer)#Game Logic, check who win
        print("")
        game_on=GameLogic.play_again()#Game Logic, check does player want to play again?
    return result# return who win, 1-means win dealer,2-means player

cards=[Card("Spades","Nine"),Card("Hearts","Ten"),\
Card("Hearts","Ten"),Card("Hearts","Seven"),Card("Clubs","Two"),Card("Diamonds","Three")]
main(cards)
